...
const recipient = new PublicKey(process.argv[2] ?? keypair.publicKey.toBase58())
...
const outputPath = await writeSignedTransaction('signed-sol-transfer', serializedBase64)
...
console.log(`Lamports: ${lamports.toString()} (${Number(lamports) / LAMPORTS_PER_SOL} SOL)`)
